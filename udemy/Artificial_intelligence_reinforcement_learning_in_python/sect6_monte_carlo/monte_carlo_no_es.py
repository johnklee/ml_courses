...
# https://www.udemy.com/course/artificial-intelligence-reinforcement-learning-in-python/learn/lecture/6430734
...
if __name__ == '__main__':
  ...
  for i in range(grid.rows):
    for j in range(grid.cols):
      state = GridState(i, j)
      if state in state_sample_count:
        state_sample_count_arr[i,j] = state_sample_count[state]
